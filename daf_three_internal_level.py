...
def _build_file_paths():
  loader_configs['src_file_path'] = file_paths_worker.build_source_hour_file_path(configs=loader_configs)
...
dat_dag = DAG(dag_id='daf_three_internal_level', schedule='@daily', default_args=default_args, catchup=False)

loader_configs = configs_worker.fetch_loader_configs(loader_name="THREE_INTERNAL_LEVEL")
