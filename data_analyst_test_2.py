...
def _build_file_paths(*context):
  context['loader_configs']['source_file_path'] = src_dst_worker.build_source_file_path(configs=context['loader_configs'])
  context['loader_configs']['destination_file_path'] = src_dst_worker.build_destination_file_path(configs=context['loader_configs'])
  return context
...
source_file_exception = PythonOperator(task_id='source_file_exception', dag=dat_dag)

download_source_file = PythonOperator(task_id='download_source_file', dag=dat_dag)
...
validation_failed_exception = PythonOperator(task_id='validation_failed_exception', dag=dat_dag)

drop_destination_data = PythonOperator(task_id='drop_destination_data', trigger_rule='none_failed_or_skipped', dag=dat_dag)

transform_load_destination = PythonOperator(task_id='transform_load_destination', trigger_rule='none_failed_or_skipped', dag=dat_dag)
