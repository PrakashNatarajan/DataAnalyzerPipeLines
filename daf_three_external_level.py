...
dat_dag = DAG(dag_id='daf_three_external_level', schedule='@daily', default_args=default_args, catchup=False)

loader_configs = configs_worker.fetch_loader_configs(loader_name="THREE_EXTERNAL_LEVEL")
